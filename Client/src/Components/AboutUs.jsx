        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              <img src="../../public/assets/Shihab.jpg" alt="Team Member" className="w-32 h-32 rounded-full mb-4 shadow-lg object-cover" />
              <h3 className="text-xl font-semibold">Md. Shihab Tawsif Shown</h3>
              <p className="text-gray-600">221 1939 042 </p>
            </div>
            <div className="flex flex-col items-center text-center">
              <img src="../../public/assets/Rayeed.jpg" alt="Team Member" className="w-32 h-32 rounded-full mb-4 shadow-lg object-cover" />
              <h3 className="text-xl font-semibold">Rayeed Aabir Ahsan</h3>
              <p className="text-gray-600">221 2905 642</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <img src="../../public/assets/Mafin.jpg" alt="Team Member" className="w-32 h-32 rounded-full mb-4 shadow-lg object-cover" />
